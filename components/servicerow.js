    ...
    return (
      <section className='h-[40vh] lg:h-[50vh] hover:border border-[tan] w-[100%] hover:shadow-sm shadow-[tan] rounded-md'>
        <div className={`rounded-md ${imageClass}`}>
          <div className=' h-full bg-[#26282A]/70 flex flex-col gap-2 justify-center items-center text-center text-transparent rounded-md font-bold text-lg hover:text-[tan]'>
